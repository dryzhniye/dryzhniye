...
export default function Home() {
  return (
    <>
      ...
      <Typography variant={'medium-text-14'} font={'roboto'} as={'div'} className={s.spanColor}>
        Hello World
      </Typography>
      <Typography variant={'regular-text-14'} font={'roboto'} as={'div'} className={s.spanColor}>
        Hello World
      </Typography>
      <Typography variant={'large'} font={'roboto'} as={'div'} className={s.spanColor}>
        Hello World
      </Typography>
